...
async function uploadCincinnatiDocs() {
  console.log('📤 Uploading Cincinnati Documents to S3...\n');
  ...
  try {
    ...
    if (!fs.existsSync(ordinancesPath)) {
      console.error(`❌ File not found: ${ordinancesPath}`);
      return;
    }
    ...
    console.log(`📄 Uploading: full-ordinances.txt (${fileSizeMB} MB)`);
    ...
    console.log('✓ Successfully uploaded to: cincinnati-oh/ordinances/full-ordinances.txt\n');
...
`;
    ...
    console.log('✓ Created README.md in ordinances folder\n');

    console.log('✅ Upload complete!\n');
    console.log('📊 S3 Bucket Status:');
    console.log('   ✓ Cincinnati ordinances organized');
    console.log('   ✓ Folder structure ready for additional data');
    console.log('\n📁 Next steps:');
